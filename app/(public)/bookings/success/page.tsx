...
export default function BookingSuccessPage() {
  ...
  useEffect(() => {
    const fetchConfirmedBooking = async () => {
      ...
      try {
        ...
        // Dynamic path querying Prisma via your custom transaction index block
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted/20 flex items-center justify-center px-6 py-12">
      <div className="max-w-md w-full text-center">
        {/* SUCCESS BADGE VECTOR */}
        <div className="mx-auto w-20 h-20 bg-emerald-500/10 dark:bg-emerald-500/20 rounded-full flex items-center justify-center mb-6">
        ...
        <div className="space-y-4">
          ...
          <Button
            ...
            size="lg"
            onClick={() => router.push("/")}
            className="w-full font-semibold rounded-xl border border-border hover:bg-muted/40 transition-colors"
          >
